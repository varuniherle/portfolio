const data = {
    ...
    "experience":[
        ...
        },
        {
          ...
          "desc" :["Implemented new features and functionalities based on user requirements and business needs.", "Improved application performance and user experience through code optimization",
          "Volunteered to build a dashboard for application performance monitoring using React JS",
