const data = {
  "about": "Proficient software engineer with 3+ years of experience in developing Python Services. I am experienced in enhancing applications and managing full-cycle deployments using Azure DevOps. Currently exploring AI-based solutions and automation tools like n8n, OpenAI to drive continuous improvement and efficiency.",

  "skills": {
    "Programming Languages": ["Python", "JavaScript"],
    "Web Design": ["HTML5", "CSS", "React JS", "Flask"],
    "Database": ["MySQL", "PL/SQL basic"],
    "Core Competencies": ["Problem-Solving", "Data Structures and Algorithms", "Troubleshooting", "System Monitoring", "Unit Testing"],
    "Methodologies": ["Agile", "DevOps", "CI/CD", "OOPS"]
  },
  ...
  "education": [
    ...
    },
    {
      ...
      "class": "10th or SSLC",
      "grade_type": "Percentage",
      "desc": "I have taken part in many cultural and athletic events."
    }
  ],
  ...
  "experience": [
    {
      ...
      "Year of joining": "Sept 2024",
      "end date": "Present",
      "client": [
        {
          "client": "Digital Platform Full Stack",
          "role": "Specialist",
          "desc": [
